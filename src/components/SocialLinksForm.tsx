...
export default function SocialLinksForm({ CompanyRegisterData, setCompanyRegisterData, setSelectedStep }: { CompanyRegisterData: any, setCompanyRegisterData: any, setSelectedStep: any }) {
